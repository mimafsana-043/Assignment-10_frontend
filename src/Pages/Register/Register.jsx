    ...
    return (
        <div>
            <div className=" flex flex-col justify-center items-center">
                <form onSubmit={handleRegister} className="flex flex-col justify-center items-center w-96  pb-32">
                    ...
                    <button type="submit" className="btn bg-white text-black border-[#e5e5e5] w-80 rounded-md mt-4 mb-4" onClick={handleGoogleLogin}>
